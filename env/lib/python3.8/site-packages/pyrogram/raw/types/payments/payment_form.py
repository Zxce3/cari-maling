...
class PaymentForm(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["bot_id", "invoice", "provider_id", "url", "users", "can_save_credentials", "password_missing", "native_provider", "native_params", "saved_info", "saved_credentials"]
