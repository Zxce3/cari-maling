...
class ChatFull(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["id", "about", "participants", "notify_settings", "exported_invite", "can_set_username", "has_scheduled", "chat_photo", "bot_info", "pinned_msg_id", "folder_id"]

    ID = 0x1b7c9db3
    QUALNAME = "types.ChatFull"

    def __init__(self, *, id: int, about: str, participants: "raw.base.ChatParticipants", notify_settings: "raw.base.PeerNotifySettings", exported_invite: "raw.base.ExportedChatInvite", can_set_username: Union[None, bool] = None, has_scheduled: Union[None, bool] = None, chat_photo: "raw.base.Photo" = None, bot_info: Union[None, List["raw.base.BotInfo"]] = None, pinned_msg_id: Union[None, int] = None, folder_id: Union[None, int] = None) -> None:
        self.id = id  # int
