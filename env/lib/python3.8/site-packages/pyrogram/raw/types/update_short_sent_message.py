...
class UpdateShortSentMessage(TLObject):  # type: ignore
    ...
    def __init__(self, *, id: int, pts: int, pts_count: int, date: int, out: Union[None, bool] = None, media: "raw.base.MessageMedia" = None, entities: Union[None, List["raw.base.MessageEntity"]] = None) -> None:
        self.id = id  # int
        self.pts = pts  # int
