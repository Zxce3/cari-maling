...
class UpdateShortChatMessage(TLObject):  # type: ignore
    ...
    def read(data: BytesIO, *args: Any) -> "UpdateShortChatMessage":
        ...
        return UpdateShortChatMessage(id=id, from_id=from_id, chat_id=chat_id, message=message, pts=pts, pts_count=pts_count, date=date, out=out, mentioned=mentioned, media_unread=media_unread, silent=silent, fwd_from=fwd_from, via_bot_id=via_bot_id, reply_to=reply_to, entities=entities)
