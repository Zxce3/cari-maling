...
class MessageFwdHeader(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["date", "from_id", "from_name", "channel_post", "post_author", "saved_from_peer", "saved_from_msg_id", "psa_type"]

    ID = 0x5f777dce
    QUALNAME = "types.MessageFwdHeader"

    def __init__(self, *, date: int, from_id: "raw.base.Peer" = None, from_name: Union[None, str] = None, channel_post: Union[None, int] = None, post_author: Union[None, str] = None, saved_from_peer: "raw.base.Peer" = None, saved_from_msg_id: Union[None, int] = None, psa_type: Union[None, str] = None) -> None:
        self.date = date  # int
    ...
    def read(data: BytesIO, *args: Any) -> "MessageFwdHeader":
        ...
        return MessageFwdHeader(date=date, from_id=from_id, from_name=from_name, channel_post=channel_post, post_author=post_author, saved_from_peer=saved_from_peer, saved_from_msg_id=saved_from_msg_id, psa_type=psa_type)
