...
class UpdateChannelParticipant(TLObject):  # type: ignore
    ...
    def __init__(self, *, channel_id: int, date: int, user_id: int, qts: int, prev_participant: "raw.base.ChannelParticipant" = None, new_participant: "raw.base.ChannelParticipant" = None) -> None:
