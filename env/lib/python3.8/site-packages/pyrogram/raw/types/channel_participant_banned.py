...
class ChannelParticipantBanned(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["user_id", "kicked_by", "date", "banned_rights", "left"]

    ID = 0x1c0facaf
    QUALNAME = "types.ChannelParticipantBanned"

    def __init__(self, *, user_id: int, kicked_by: int, date: int, banned_rights: "raw.base.ChatBannedRights", left: Union[None, bool] = None) -> None:
