...
class InputMediaInvoice(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["title", "description", "invoice", "payload", "provider", "provider_data", "start_param", "photo"]

    ID = 0xf4e096c3
    QUALNAME = "types.InputMediaInvoice"

    def __init__(self, *, title: str, description: str, invoice: "raw.base.Invoice", payload: bytes, provider: str, provider_data: "raw.base.DataJSON", start_param: str, photo: "raw.base.InputWebDocument" = None) -> None:
