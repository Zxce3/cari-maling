...
class ChatPhoto(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["photo_small", "photo_big", "dc_id", "has_video"]

    ID = 0xd20b9f3c
    QUALNAME = "types.ChatPhoto"

    def __init__(self, *, photo_small: "raw.base.FileLocation", photo_big: "raw.base.FileLocation", dc_id: int, has_video: Union[None, bool] = None) -> None:
