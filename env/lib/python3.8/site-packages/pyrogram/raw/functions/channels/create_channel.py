...
class CreateChannel(TLObject):  # type: ignore
    ...
    def __init__(self, *, title: str, about: str, broadcast: Union[None, bool] = None, megagroup: Union[None, bool] = None, geo_point: "raw.base.InputGeoPoint" = None, address: Union[None, str] = None) -> None:
