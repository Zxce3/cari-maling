...
class SendPaymentForm(TLObject):  # type: ignore
    ...
    def __init__(self, *, msg_id: int, credentials: "raw.base.InputPaymentCredentials", requested_info_id: Union[None, str] = None, shipping_option_id: Union[None, str] = None) -> None:
